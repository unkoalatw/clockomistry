...
- **全新 Workspace 啟動器與動線優化**：移除了原本雜亂且容易擋住畫面的「頂部雙層工具列」，並將底部導航列極簡化為「時鐘主頁」與「工具箱 (Apps)」兩大核心按鈕！點擊 Apps 後會展開宛如 iOS Launchpad 的大圖示應用清單，想用什麼工具一目瞭然，徹底改善了過往各種功能按鈕擠在一起的擁擠感。
